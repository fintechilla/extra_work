...
public class ExcelRead {
	...
	public static void main(String[] args) {
		...
		String path = "C://Devs//new_xw//extra_work//Eclipse//seleniumWDTutorial//src//datadriven//2-ExcelRead.xlsx";
		//"C:\\Devs\\new_xw\\extra_work\\Eclipse\\seleniumWDTutorial\\src\\datadriven\\ExcelRead.xlsx";
...
//			System.out.println("Cell Data: " + ExcelWSheet.getRow(1).getCell(0).getStringCellValue());
